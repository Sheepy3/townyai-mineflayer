...
bot.on('physicsTick', async () => {
  ...
  bot.entity.position.distanceTo(potential_target.position) > reach &&
  bot.entity.position.distanceTo(potential_target.position) < kited_range
) {
    move_to_target();
}
});
